...
export const de: SiteContent = {
  ...
  signup: {
    metaTitle: "Covaga Hub — Loslegen",
    metaDescription: "Erstelle deinen Covaga-Hub-Tenant: verbinde einen Telegram-Bot und route deine ECAD-Ereignisse in Minuten.",
    eyebrow: "loslegen",
