...
export const en: SiteContent = {
  ...
  signup: {
    metaTitle: "Covaga Hub — Join the waitlist",
    metaDescription: "Covaga Hub is under development. Leave your email and we'll let you know the moment it opens.",
    eyebrow: "early access",
    heading: "Covaga Hub is almost ready",
    lead: "We're still building Covaga Hub. Leave your email and we'll tell you the moment it opens — one message, no spam.",
    emailLabel: "Work email",
    companyLabel: "Company (optional)",
    submit: "Notify me",
    submitting: "Sending…",
    errorGeneric: "Something went wrong. Check your email and try again.",
    successHeading: "You're on the list",
    successLead: "Thanks — we'll email you the moment Covaga Hub opens. Meanwhile, the client and tools are open source on GitHub.",
