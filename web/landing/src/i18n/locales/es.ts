...
export const es: SiteContent = {
  ...
  signup: {
    metaTitle: "Covaga Hub — Únete a la lista",
    metaDescription: "Covaga Hub está en desarrollo. Déjanos tu email y te avisamos en cuanto esté disponible.",
    eyebrow: "acceso anticipado",
    heading: "Covaga Hub está casi listo",
    lead: "Todavía estamos construyendo Covaga Hub. Déjanos tu email y te avisamos en cuanto esté disponible — un solo mensaje, sin spam.",
    emailLabel: "Email de trabajo",
    companyLabel: "Empresa (opcional)",
    submit: "Avísame",
    submitting: "Enviando…",
    errorGeneric: "Algo ha fallado. Revisa tu email e inténtalo de nuevo.",
    successHeading: "Estás en la lista",
    successLead: "Gracias — te escribiremos en cuanto Covaga Hub esté disponible. Mientras tanto, el cliente y las herramientas son de código abierto en GitHub.",
