...
export const ko: SiteContent = {
  ...
  signup: {
    metaTitle: "Covaga Hub — 대기자 명단 등록",
    metaDescription: "Covaga Hub는 개발 중입니다. 이메일을 남겨 주시면 출시되는 즉시 알려드립니다.",
    eyebrow: "얼리 액세스",
    heading: "Covaga Hub가 곧 출시됩니다",
    lead: "아직 Covaga Hub를 만들고 있습니다. 이메일을 남겨 주시면 출시되는 즉시 알려드립니다 — 한 번의 메일, 스팸 없음.",
    emailLabel: "업무용 이메일",
    companyLabel: "회사명 (선택)",
    submit: "알림 받기",
    submitting: "보내는 중…",
    errorGeneric: "문제가 발생했습니다. 이메일을 확인하고 다시 시도하세요.",
    successHeading: "명단에 등록되었습니다",
    successLead: "감사합니다 — Covaga Hub가 출시되는 즉시 이메일로 알려드립니다. 그동안 클라이언트와 도구는 GitHub에서 오픈 소스로 제공됩니다.",
