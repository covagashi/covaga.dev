...
export const ko: SiteContent = {
  meta: {
    homeTitle: "byndr — ECAD 내보내기를 어디로든 라우팅",
    homeDescription:
      "byndr은 여러분의 ECAD 내보내기 — PDF, BOM, 프로젝트 마감 — 를 감지하여 Teams, SharePoint, Drive 또는 이메일로 전달합니다. 자격 증명은 서버 측에 보관되고, 클라이언트는 오픈 소스로 공개됩니다.",
    privacyTitle: "byndr — 개인정보 처리방침",
    privacyDescription:
      "byndr이 웹사이트와 호스팅형 이벤트 라우팅 서비스 전반에서 데이터를 처리하는 방식입니다.",
    termsTitle: "byndr — 이용약관",
    termsDescription:
      "byndr 호스팅형 이벤트 라우팅 서비스와 오픈 소스 클라이언트의 이용을 규율하는 약관입니다.",
  },
  a11y: {
  ...
  hero: {
    ...
    leadHtml:
      'byndr은 여러분의 <strong class="font-semibold text-[var(--color-ink)]">ECAD</strong> 내보내기를 감지하여 Teams, SharePoint, Drive 또는 이메일로 전달합니다 — 자격 증명은 서버 측에 보관됩니다.',
    ctaPrimary: "시작하기",
    ctaSecondary: "작동 방식 보기",
    schemaTitle: "이벤트 라우팅 회로도",
    schemaDesc:
      "배선 회로도: 왼쪽의 세 개 ECAD 이벤트 단자가 byndr 허브 모듈을 거쳐 오른쪽의 SharePoint, Teams, Drive, Email 단자로 라우팅됩니다.",
  ...
  events: {
    ...
    footnote:
      "Slack이 없다고요? 의도된 설계입니다 — byndr은 여러분의 사무실이 이미 운영하는 M365 + PLM 스택의 언어를 씁니다. 다른 것이 필요한가요? 범용 HTTP 목적지가 페이로드를 어디로든 전달합니다.",
  },
  pricing: {
    eyebrow: "요금제",
  ...
  faq: {
    ...
    items: [
      {
        q: "어떤 ECAD 도구를 지원하나요?",
        a: "byndr은 ECAD에 종속되지 않습니다. 오픈 소스 클라이언트가 여러분의 CAD 도구에서 이벤트를 포착하여 테넌트로 POST합니다. EPLAN Electric P8을 가장 먼저 지원하며, 클라이언트는 다른 ECAD 도구도 같은 방식으로 추가할 수 있도록 설계되었습니다.",
      },
      {
      ...
      {
        q: "왜 Slack은 없나요?",
        a: "엔지니어링 사무실은 Slack으로 돌아가지 않기 때문입니다. byndr은 여러분이 실제로 사용하는 도구 — Microsoft Teams, SharePoint, Drive, 이메일, 네트워크 폴더, 그리고 PLM/PDM — 를 대상으로 합니다. 그 밖의 것은 범용 HTTP 목적지가 처리합니다.",
      },
      {
        q: "팀의 업무 방식을 바꿔야 하나요?",
        a: "아니요. 엔지니어는 오늘 하던 그대로 PDF와 BOM을 내보내면 됩니다. byndr이 그 이벤트를 감지하여 전달하므로 새로 배워야 할 도구가 없습니다.",
      },
    ],
  },
  signup: {
    metaTitle: "byndr — 시작하기",
    metaDescription: "byndr 테넌트 생성: Telegram 봇을 연결하고 몇 분 만에 ECAD 이벤트를 라우팅하세요.",
    eyebrow: "시작하기",
    heading: "테넌트 만들기",
    ...
    nextSteps: [
      ...
      "byndr.config를 %APPDATA%\\byndr\\에 복사하고 tenantId와 apiKey를 붙여넣습니다.",
      "EPLAN에서 scripts/ByndrPing.cs를 실행한 뒤 Events 페이지에서 라우팅할 이벤트를 선택합니다.",
    ],
  },
  footer: {
    tagline:
    ...
    contact: "문의",
    disclaimer:
      "byndr은 독립 제품이며, EPLAN 또는 어떤 ECAD 공급업체와도 제휴하거나 보증받지 않았습니다. 모든 제품명은 해당 소유자의 상표입니다.",
  },
  legal: {
    back: "byndr으로 돌아가기",
    ...
    privacy: {
      ...
      title: "개인정보 처리방침",
      intro:
        "데이터 수집은 최소한으로, 자격 증명은 서버 측에 보관합니다. byndr이 처리하는 것과 그 이유를 정확히 설명합니다.",
      sections: [
        {
          heading: "우리는 누구인가",
          body: [
            "byndr은 ECAD 이벤트를 엔지니어링 팀이 사용하는 도구로 라우팅하는 독립 제품입니다. 본 방침은 여러분이 저희 웹사이트와 호스팅형 서비스를 이용할 때 저희가 어떤 데이터를 처리하는지 설명합니다.",
          ],
        },
        {
          heading: "수집하는 정보",
        ...
        },
        {
          heading: "여러분의 권리",
          body: [
            "여러분은 hello@covaga.xyz로 이메일을 보내 저희가 보유한 개인정보에 대한 접근, 정정, 삭제를 언제든지 요청할 수 있습니다. 저희는 합리적인 기간 내에 응답하겠습니다.",
          ],
        },
        {
          heading: "변경 사항",
      ...
      sections: [
        {
          heading: "서비스",
          body: [
            "byndr은 오픈 소스 클라이언트로부터 ECAD 이벤트를 수신하여 여러분이 구성한 목적지로 전달하는 호스팅형 라우터를 제공합니다. 클라이언트는 MIT 라이선스이며, 호스팅형 서비스는 본 약관에 따라 제공됩니다.",
          ],
        },
        {
          heading: "여러분의 책임",
        ...
        },
        {
          heading: "책임",
          body: [
            "법이 허용하는 범위 내에서, byndr은 서비스 사용으로 발생하는 간접적 또는 결과적 손해에 대해 책임을 지지 않습니다. 호스팅형 서비스는 여러분의 파일을 이동시키며, 독립적인 백업을 유지하는 것은 여러분의 책임입니다.",
          ],
        },
        {
          heading: "변경 사항",
