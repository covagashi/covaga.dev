...
export const zhCn: SiteContent = {
  ...
  signup: {
    metaTitle: "Covaga Hub — 加入等候名单",
    metaDescription: "Covaga Hub 正在开发中。留下您的邮箱，上线时我们会第一时间通知您。",
    eyebrow: "抢先体验",
    heading: "Covaga Hub 即将上线",
    lead: "我们仍在开发 Covaga Hub。留下您的邮箱，上线时我们会第一时间通知您 —— 只发一封，绝无垃圾邮件。",
    emailLabel: "工作邮箱",
    companyLabel: "公司（可选）",
    submit: "通知我",
    submitting: "发送中…",
    errorGeneric: "出现问题。请检查您的邮箱后重试。",
    successHeading: "您已加入名单",
    successLead: "谢谢 —— Covaga Hub 上线时我们会立即通过邮件通知您。在此期间，客户端和工具已在 GitHub 上开源。",
